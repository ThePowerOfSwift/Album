...
class MomentCollectionLayout:UICollectionViewFlowLayout{
    ...
    var naviHeight:CGFloat = 64//默认分组停放高度
    ...
    override init() {
        ...
        self.naviHeight = size.width > size.height  ? 44 : 64
    }
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        for (idx,_) in noneHeaderSections.enumerated() {
...
//        for arrtibutes:UICollectionViewLayoutAttributes in superArray!{
//            
//            if arrtibutes.representedElementKind == UICollectionElementKindSectionHeader {
//                
//                if let resuview = self.collectionView?.supplementaryViewForElementKind(UICollectionElementKindSectionHeader, atIndexPath: arrtibutes.indexPath) as? MomentReusableView{
//                
//                    if arrtibutes.frame.origin.y <= 0 {
//                        
//                        resuview.backgroundColor = UIColor.redColor()
//                    }else{
//                        
